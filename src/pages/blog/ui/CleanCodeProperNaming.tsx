    ...
    return (
        <Section>
            ...
            <ListItem>
                ...
                Good: using only one of them.
                <br/>
                Bad: add method in UserService adds an element at the end of an array, add method in ProductService
                concatenates
                2 arrays.
                <br/>
            ...
            <ListItem>
                ...
                <br/>
                Just the name UserRepository should prevent others from adding other functionality that doesn't belong
                there.
            </ListItem>
            ...
            <Text><strong>6. Granular and specific as possible</strong>. The Name marks <strong>the intent</strong>.
                ...
                <br/>
                There is a thin line between being <strong>as specific as possible</strong> and <strong>avoiding
                    noise</strong>,
                but the <strong>former one</strong> is worse, so <strong>be specific as possible even if you add
                    noise</strong>.
            </Text>
            <ListItem>
                Variables:
            ...
            <ListItem>
                ...
                Bad: CurrencyI.
                <br/>
                Is this an Interface? Is this a Class implementation for Israeli/Indonesian/Iceland Currency? Is this
                Currency
                Index?
                <br/>
                Bad: UserAuth.
            ...
            <Text><strong>9. if/and/or/etc.. are signs that the single responsibility principle is not
                respected</strong>.
                <br/>
