...
export default () => {
    ...
    return (
        <Section>
            ...
            <Subtitle>
                Deciding between using GraphQL and REST can always be a tough decision, so we’re gonna show the Pros and
                Cons of
                using each.
            </Subtitle>
            ...
            <ListItem2>
                Schema is displayed to the Client - Schema Definition Language (SDL). {'=>'} the Frontend and Backend
                teams
            ...
            <ListItem>The client has to respect the schema type or an error is thrown {'=>'} Correct usage of Schema
                Definition
                Language is enforced in UI.</ListItem>
            <ListItem>Involves both the Frontend and the Backend Developers in understanding the GraphQL
                contract.</ListItem>
            ...
            <ListItem2>Facebook has released DataLoader which can make GraphQL client caching easier, but clients not
                using
            ...
            <ListItem2>Has duplicated Queries/Mutations in many components and it's a Hell when you end up having many
                similar
                Queries/Mutations present in multiple components.</ListItem2>

            <ListItem>To reuse code written for Queries/Mutations you may end up with components that do Over-fetching.
                For
            ...
            <ListItem>Error handling gives you a 200 OK status code. Handled as part of the response body under a
                special
            ...
            <ListItem2>this means that the entity logic is present more in BE, and there are a lot of mature tools for
                many
            ...
            <ListItem2>note that network becomes useless if the endpoint caching is very customisable.
                ...
                ex.
                <br/>
                adding a selection of subfields will make the endpoint more customisable, but the network caching less
                efficient
                <br/>
