...
export default () => {
    ...
    return (
        <Section>
            ...
            <Subtitle>
                This article will show you how <strong>clean functions</strong> can help you <strong>avoid duplicated
                code,
                avoid indentation(or arrow
                code)</strong> and <strong>mark real intent</strong>. After that we’ll show you some <strong>tips for
                improving
            ...
            <Subtitle>
                ...
                The main difference between a method and a function is that a method is on an object. A function is
                independent
            ...
            <Subtitle>
                ...
                <strong>This article will show that clean functions are way more complex than that</strong>, find out
                more!
            </Subtitle>
        ...
        `
            ...
            <Text>
                Understanding the intent of a function is really important. Comments are often a good solution, but a
                good
        ...
        `
            ...
            <ListItem>
                Stick to the <strong>7 rule: Most adults can store between 5 and 9 items in their short-term
                memory</strong>.
            ...
            <ListItem>
                <strong>Handle exception at the root level</strong>, don’t allow for try and catch blocks to spawn like
                baby
                rabbits.
            </ListItem>
